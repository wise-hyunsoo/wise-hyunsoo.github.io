...
$$
\begin{align*}
p(a_0,s_1,a_1,\cdots,a_T,s_T|s_0,\pi) &= \pi(a_0|s_0)p_{\text{env}}(o_1|a_0)\delta(s_1=U(s_0,a_0,o_1)) \\

&\times \pi(a_1|s_1) p_\text{env}(o_2|a_1,o_1)\delta(s_2=U(s_1,a_1,o_2)) \\

& \times \pi(a_2|s_2)p_\text{env}(o_3|a_{1:2},o_{1:2})\delta(s_3=U(s_2,a_2,o_3))
